...
all exported within the `nt2` namespace. You can browse
...
The `pbegin()` and `pend()` functions are helpers provided by
RcppNT2 -- they provide pointers (rather than iterators) to

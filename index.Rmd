...
**NT<sub>2</sub>** provides with a large toolbox of
algorithms, facilitating scientific computing for many
tasks. Browse the [User Manual](http://nt2.metascale.fr/doc/html/user_manual0.html) 
to get an overview of what functions are provided by 
**NT<sub>2</sub>**. By including `<RcppNT2.h>`, these
functions are all made available as part of the `nt2`
namespace, and so are immediately ready to use.
